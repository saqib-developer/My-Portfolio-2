      ...
      <>
         <header>
            <nav>
               <a href="/">
                  <img
                     src="img\Screenshot_20230503-190452.jpg"
                     alt="logo"
                     loading="lazy"
                  />
               </a>
         ...
         <main>
            ...
            <div className="para-1">
               <p>
                  <span style={{ fontSize: "50px", lineHeight: "46px" }}>
                     {displayText3}
                  </span>
                  <br />
                  Currently, I'm working at
                  <a
                     href="https://www.fiverr.com/share/pAR6Eo"
                     target="_blank"
                     rel="noreferrer"
                     style={{ color: "#00b22d" }}
                  >
            ...
            <div className="para-2">
               I specialize in creating custom websites using HTML, CSS, and
               JavaScript. With a meticulous approach, I work closely with
               clients to understand their unique businesses, brand, and goals.
               By combining your vision with my technical expertise, I can
               create websites that not only have visually stunning designs but
               are also functional, user-friendly, and responsive across all
               devices. My goal is to deliver an exceptional online presence
               that engages your target audience and helps you achieve your
               digital objectives.
            </div>
               ...
               <Tilt options={defaultOptions}>
                  ...
                  >
                     ...
                     <div className="details">
                        <h3>HTML5:</h3>
                        <p>
                           Proficient in creating the structure and layout of
                           web pages using HTML, ensuring proper content
                           hierarchy and semantic markup for enhanced
               ...
               <Tilt options={defaultOptions}>
                  ...
                  >
                     ...
                     <div className="details">
                        <h3>CSS3:</h3>
                        <p>
                           Skilled in applying CSS styles and design principles
                           to create visually appealing and responsive websites,
                           leveraging selectors, flexbox, grid, and animations
            ...
            <div className="dow">
               <Tilt options={defaultOptions}>
                  ...
                  >
                     <img
                        src="img/icons/javascript logo.png"
                        alt=""
                        loading="lazy"
                     />
                     <div className="details">
                        <h3>JAVASCRIPT:</h3>
                        <p>
                           Experienced in JavaScript, enabling dynamic and
                           interactive web functionality, including event
                           handling, DOM manipulation, AJAX, and utilizing
                           libraries and frameworks for efficient development.
                        </p>
                        <button>
                           <a
                              target="_blank"
            ...
            <div className="experience">
               <div className="para-3">
                  I have successfully completed numerous projects, including
                  personal endeavors and collaborations with clients on{" "}
                  <a
                     href="https://www.fiverr.com/share/pAR6Eo"
                     target="_blank"
                     rel="noreferrer"
                  ...
                  . I take pride in my work, and you can explore a selection of
                  these projects{" "}
                  <a
                     href="/"
                     onClick={(event) => {
            ...
            <div className="project-container" id="project-container">
               ...
               <a
                  target="_blank"
                  rel="noreferrer"
                  href="https://amazon-clone-saqib.netlify.app/"
               >
                  <div
                     key={elements[4].id}
                     id={elements[4].id}
                  ...
                  >
                     ...
                     <div className="pro-detail">
                        <p>
                           I have developed a feature-rich Amazon clone website
                           that incorporates essential functionalities such as a
                           seamless cart option, ad posting capabilities, and
                           user account management using Firebase's robust
                           database and authentication services.
                        </p>
                        <img
                           style={{ boxShadow: "-6px -10px 18px 0px #a7a7a7" }}
               ...
               <a
                  target="_blank"
                  rel="noreferrer"
                  href="https://chatty-saqib.netlify.app/"
               >
                  <div
                     key={elements[5].id}
                     id={elements[5].id}
                  ...
                  >
                     ...
                     <div className="pro-detail">
                        <p>
                           Chatty is a react based web app that allows you to
                           have casual conversations with friends and family or
                           anyone for that matter. Chatty is a great way to stay
                           connected with your loved ones, no matter where they
                           are in the world. It uses firesbase for
                           Authentication, Database and Storage purposes
                        </p>
                        <img
                           style={{ boxShadow: "-6px -10px 18px 0px #00235a" }}
                           src="img/Chatty.png"
                           alt=""
                           loading="lazy"
                        />
               ...
               <a
                  target="_blank"
                  rel="noreferrer"
                  href="https://mtouseef-portfolio.netlify.app/"
               >
                  <div
                     key={elements[6].id}
                     id={elements[6].id}
                  ...
                  >
                     ...
                     <div className="pro-detail">
                        <p>
                           I have designed a captivating portfolio showcasing my
                           friend's expertise as a game developer. The portfolio
                           includes a Firebase-integrated database, allowing him
                           to effortlessly upload and showcase his impressive
                           projects to demonstrate his skills and creativity in
                           the gaming industry.
                        </p>
                        <img
                           style={{ boxShadow: "-6px -10px 18px 0px #9400c6" }}
                           src="img/Friend-project.png"
                           alt=""
                           loading="lazy"
                        />
                     </div>
               ...
               <a
                  target="_blank"
                  rel="noreferrer"
                  href="https://msntictactoe.netlify.app/"
               >
                  <div
                     key={elements[7].id}
                     id={elements[7].id}
                  ...
                  >
                     ...
                     <div className="pro-detail">
                        <p>
                           I have crafted a dynamic Tic Tac Toe game that
                           provides an engaging experience for two players. With
                           its intuitive interface and smooth gameplay, this
                           project showcases my ability to design and develop
                           interactive games that entertain and challenge
                           players.
                        </p>
                        <img
                           src="img/TicTacToe pic.png"
                           alt=""
                           loading="lazy"
                        />
                     </div>
               ...
               <a
                  target="_blank"
                  rel="noreferrer"
                  href="https://saqibsaqib123.github.io/Clock/"
               >
                  <div
                     key={elements[8].id}
                     id={elements[8].id}
                  ...
                  >
                     ...
                     <div className="pro-detail">
                        <p>
                           I have crafted a visually stunning analogue clock
                           that elegantly displays the current time. Experience
                           the timeless charm of a traditional clock with this
                           captivating and functional design.
                        </p>
               ...
               <a
                  target="_blank"
                  rel="noreferrer"
                  href="https://saqibsaqib123.github.io/Calculator/"
               >
                  <div
                     key={elements[9].id}
                     id={elements[9].id}
                  ...
                  >
                     ...
                     <div className="pro-detail">
                        <p>
                           A React-based web app calculator is a simple and
                           easy-to-use calculator that is built with the React
                           JavaScript library. It allows users to perform basic
                           and advanced calculations, such as addition,
            ...
            <div className="contact" id="contact">
               ...
               <p>
                  If you want to discuss any thing related to web development
               ...
               <div className="logos">
                  ...
                  <a
                     href="mailto:muhammadsaqib8379@gmail.com"
                     target="_blank"
                     rel="noopener noreferrer"
                  >
                     <img
                        src="img/icons/email-logo.png"
                        alt=""
                        style={{ borderRadius: 0 }}
                     />
                  </a>
                  <a
                     href="https://www.linkedin.com/in/muhammad-saqib-nawaz-868871257/"
                     target="_blank"
                     rel="noopener noreferrer"
                  >
